...
class AptPriceItem(BaseModel):
    ...
    is_exact_location: bool | None = Field(default=None, description="정확한 좌표 여부(지오코딩 실패 건은 null일 수 있음)")
    updated_at: datetime | None = Field(default=None, description="데이터 갱신 시각(값이 없을 수 있음)")
